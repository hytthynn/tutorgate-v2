...
export const RichMessage=memo(function RichMessage({content}:{content:RichContent}){return <div className="chat-rich-document">{markdownDocument(content).blocks.map((b,i)=>{
