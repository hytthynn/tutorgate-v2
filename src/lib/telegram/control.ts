...
import { updateControlMessage, type ControlClaim } from "@/features/chats/control-message";
import { editTemplate, sendTemplate } from "./bot";
import type { TelegramMessage } from "./templates";

export function sendControlMessage(chat: string, message: TelegramMessage) {
