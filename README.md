...
Реализованы: заявка → подтверждение Telegram → одноразовая регистрация; вход по логину; восстановление через бота; три роли; назначение предметов и преподавателей; настройки; статистика с пустым источником данных. Расписание намеренно оставлено заглушкой.
