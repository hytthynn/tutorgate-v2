...
Закрытая платформа учеников, репетиторов и администратора. Источник требований: TutorGate_MVP_TZ.md.
...
## Вне scope
- Лендинг, настоящий календарь, lessons/slots/availability tables.
