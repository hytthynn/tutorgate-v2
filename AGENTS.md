...
Добавлять регрессии. Не объявлять команду пройденной, если она не выполнялась. Текущее [ТЗ](docs/TZ_TutorGate_009_bugs_applications_brand.md), [проверки](docs/verification.md). История — только docs/archive.
