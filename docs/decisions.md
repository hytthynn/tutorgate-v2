...
## ADR-005 — Расписание изолировано
Никаких lessons/availability/calendar tables. Статистика использует service contract с пустыми points и нулями; UI уже поддерживает фильтры.
