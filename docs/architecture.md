...
Общие loading-кнопки и визуальные правила — [UI](ui-guidelines.md). Текущее [ТЗ](TZ_TutorGate_010_final.md) и [фактические проверки](verification.md).
